...
#commands to download vite and run 
1) npm create vite@latest cms-frontend
go inside folder, and then -->
2) cd ems-frontend
3) npm install
4) npm run dev
5) first index.html opens --> goes to main.jsx file --> calls App Component(AppJsx)
6) <> </> = fragment tag
